...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def get_avatar(self):
        if self.avatar:
            ...
            return 'https://sun6-21.userapi.com/s/v1/if1/zJ1bldH0s_clKHi40sTI-LOoHeFzwmUyT3FBrzDLqTz4G68HAsuwJCL2yk8NkSEXcakoXW7D.jpg?size=200x200&quality=96&crop=36,0,215,215&ava=1'
